...
namespace ScriptCompiler.AST.Statements {
    public class DeclarationStatementNode : StatementNode {
        ...
        public DeclarationStatementNode(ExplicitTypeNode typeNode, string identifier) : this(typeNode, identifier, null) { }

        public DeclarationStatementNode(ExplicitTypeNode typeNode, string identifier, ExpressionNode initialValue) {
            TypeNode = typeNode;
